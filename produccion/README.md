...
Servicio REST API para la clasificación del *mood* de una *playlist* de Spotify. El servicio recibe como entrada la URL de la *playlist*, y el *mood* que se requiere en formato JSON: 
